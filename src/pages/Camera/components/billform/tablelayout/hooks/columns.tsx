  ...
  return [
    ...
    },
    {
      ...
      render: (_dom: any, record: any) => {
        return (
          <>
            <Checkbox checked={record.onlineStatus ?? false} />
          </>
        );
      },
    },
    {
      ...
      render: (_dom: any, record: any) => {
        return (
          <>
            <Checkbox checked={record.enabled ?? false} />
          </>
        );
      },
    },
    {
      ...
      render: (_dom: any, record: any) => {
        return (
          <>
            <Checkbox checked={record.rtmpPushStatus ?? false} />
          </>
        );
      },
    },
    {
      ...
      render: (_dom: any, record: any) => {
        return (
          <>
            <Checkbox checked={record.saveVideo ?? false} />
          </>
        );
      },
    },
    {
      ...
      render: (_dom: any, record: any) => {
        return (
          <>
            <Checkbox checked={record.live ?? false} />
          </>
        );
      },
    },
    {
      ...
      key: 'cameraType',
      render: (_dom: any, record: any) => {
        if (record['cameraType'] === 'rtmp') {
          return 'RTMP摄像头';
        }
        if (record['cameraType'] === 'rtsp') {
          return 'RTSP摄像头';
        }
        return '--';
      },
    },
    {
      width: 150,
      title: 'rtmp识别码',
      dataIndex: 'rtmpAuthCode',
      key: 'rtmpAuthCode',
      render: (_dom: any, record: any) => {
        return <>{record.rtmpAuthCode ? record.rtmpAuthCode : '--'}</>;
      },
    },
    {
      width: 150,
      ...
      render: (_dom: any, record: any) => {
        return (
          <>
            <Checkbox checked={record.fgPassive ?? false} />
          </>
        );
      },
    },
